                    ...
                    <div className='container'>
                        ...
                        <div className="mt-4">
                            ...
                            <div className='form-check d-flex flex-column'>
                                <label>
                                    <input type="radio" className='me-2' name="payment" value="online" onChange={handlePaymentMethodChange} checked={paymentMethod === 'online'} />
                                    Online
                                </label>
                                <label>
                                    <input type="radio" className='me-2' name="payment" value="cod" onChange={handlePaymentMethodChange} checked={paymentMethod === 'cod'} />
                                    Cash on Delivery
                                </label>
                            </div>
                        </div>
                        {cartItems.length > 0 && (
                            <div className="text-center mt-4">
                                <Button variant="contained" onClick={() => setOpenDialog(true)}>Proceed to Order</Button>
                            </div>
                        )}
